...
rollnow = (btnName) => {
    if (btnName === "play1-btn") {
        ...
        if (ply1Score >= 30) {
            document.getElementById("resetBtn").style.backgroundColor="rgb(243, 84, 110)";
            ...
            document.getElementById("play1-btn").setAttribute("disabled", true);
            document.getElementById("play1-btn").setAttribute("class", "btn-disable");
            document.getElementById("play2-btn").setAttribute("class", "btn");
        ...
        if (ply2Score >= 30) {
            ...
            document.getElementById("play2-btn").setAttribute("disabled", true);
            document.getElementById("play2-btn").setAttribute("class", "btn-disable");
            document.getElementById("play1-btn").setAttribute("class", "btn");
...
reset = () => {
    ...
    ply1Score = 0;
    document.getElementById("play1-btn").removeAttribute("disabled");
    document.getElementById("resetBtn").style.backgroundColor="pink";
